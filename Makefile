...
CC		:= $(GCCPREFIX)gcc
LD		:= $(GCCPREFIX)ld
CFLAGS		:= -MD -Wno-strict-aliasing -Wno-unused-function -pipe -fno-builtin -nostdinc -fno-stack-protector -std=gnu89 -w
LDFLAGS		:= -nostdlib
...
CCOMP		:= $(GCCPREFIX)gcc
CCOMP_CFLAGS	:= -MD -Wno-strict-aliasing -Wno-unused-function -pipe -fno-builtin -nostdinc -fno-stack-protector -O2 -g -m32 -D__COMPCERT__ -std=gnu89 -w
endif
