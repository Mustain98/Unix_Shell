...
{
	asm volatile("int %0" :
4000000f:	8d 75 ce             	lea    -0x32(%ebp),%esi
40000012:	bb 08 00 00 00       	mov    $0x8,%ebx
40000017:	51                   	push   %ecx
40000018:	83 ec 38             	sub    $0x38,%esp
    printf("[ping] ping started.\n");
4000001b:	68 74 12 00 40       	push   $0x40001274
40000020:	e8 db 02 00 00       	call   40000300 <printf>
    char msg[] = "Hello pong, this is ping.";
40000025:	b8 2e 00 00 00       	mov    $0x2e,%eax
    unsigned int i;
    //ping 4, pong 5, ding 6
    printf("[ping] sending msg...\n");
4000002a:	c7 04 24 8a 12 00 40 	movl   $0x4000128a,(%esp)
    char msg[] = "Hello pong, this is ping.";
40000031:	c7 45 ce 48 65 6c 6c 	movl   $0x6c6c6548,-0x32(%ebp)
40000038:	c7 45 d2 6f 20 70 6f 	movl   $0x6f70206f,-0x2e(%ebp)
4000003f:	c7 45 d6 6e 67 2c 20 	movl   $0x202c676e,-0x2a(%ebp)
40000046:	c7 45 da 74 68 69 73 	movl   $0x73696874,-0x26(%ebp)
4000004d:	c7 45 de 20 69 73 20 	movl   $0x20736920,-0x22(%ebp)
40000054:	c7 45 e2 70 69 6e 67 	movl   $0x676e6970,-0x1e(%ebp)
4000005b:	66 89 45 e6          	mov    %ax,-0x1a(%ebp)
    printf("[ping] sending msg...\n");
4000005f:	e8 9c 02 00 00       	call   40000300 <printf>
40000064:	ba 1a 00 00 00       	mov    $0x1a,%edx
40000069:	b8 0f 00 00 00       	mov    $0xf,%eax
4000006e:	89 f1                	mov    %esi,%ecx
40000070:	cd 30                	int    $0x30
    sys_sync_send(8, msg, sizeof(msg));
    printf("[ping] msg sent.\n");
40000072:	c7 04 24 a1 12 00 40 	movl   $0x400012a1,(%esp)
40000079:	e8 82 02 00 00       	call   40000300 <printf>
    printf("[ping] recving msg...\n");
4000007e:	c7 04 24 b3 12 00 40 	movl   $0x400012b3,(%esp)
40000085:	e8 76 02 00 00       	call   40000300 <printf>
}
...
sys_sync_receive(int send_pid, char* addr, size_t len)
{
       int errno, length;
	asm volatile("int %2"
4000008a:	b8 10 00 00 00       	mov    $0x10,%eax
4000008f:	89 f1                	mov    %esi,%ecx
40000091:	ba 1a 00 00 00       	mov    $0x1a,%edx
40000096:	cd 30                	int    $0x30
    sys_sync_receive(8, msg, sizeof(msg));
    printf("[ping] msg from proc %d: %s\n", 5, msg);
40000098:	83 c4 0c             	add    $0xc,%esp
4000009b:	56                   	push   %esi
4000009c:	6a 05                	push   $0x5
4000009e:	68 ca 12 00 40       	push   $0x400012ca
400000a3:	e8 58 02 00 00       	call   40000300 <printf>
400000a8:	83 c4 10             	add    $0x10,%esp
    while(1) ;
400000ab:	eb fe                	jmp    400000ab <main+0xab>
...
400000ad:	f7 c4 ff ff ff 0f    	test   $0xfffffff,%esp
	jnz	args_exist
400000b3:	75 04                	jne    400000b9 <args_exist>
...
args_exist:
	/* Jump to the C part. */
	call	main
400000b9:	e8 42 ff ff ff       	call   40000000 <main>

	/* When returning, save return value */
	pushl	%eax
400000be:	50                   	push   %eax

	/* Syscall SYS_exit (30) */
	movl	$30, %eax
400000bf:	b8 1e 00 00 00       	mov    $0x1e,%eax
	int	$48
400000c4:	cd 30                	int    $0x30

400000c6 <spin>:

spin:
	call	yield
400000c6:	e8 25 09 00 00       	call   400009f0 <yield>
	jmp	spin
400000cb:	eb f9                	jmp    400000c6 <spin>
...
400000d3:	83 ec 0c             	sub    $0xc,%esp
	va_list ap;
	va_start(ap, fmt);
	printf("[D] %s:%d: ", file, line);
400000d6:	ff 75 0c             	push   0xc(%ebp)
400000d9:	ff 75 08             	push   0x8(%ebp)
400000dc:	68 38 12 00 40       	push   $0x40001238
400000e1:	e8 1a 02 00 00       	call   40000300 <printf>
	vcprintf(fmt, ap);
400000e6:	58                   	pop    %eax
400000e7:	8d 45 14             	lea    0x14(%ebp),%eax
400000ea:	5a                   	pop    %edx
400000eb:	50                   	push   %eax
400000ec:	ff 75 10             	push   0x10(%ebp)
400000ef:	e8 ac 01 00 00       	call   400002a0 <vcprintf>
	va_end(ap);
}
...
4000010c:	68 44 12 00 40       	push   $0x40001244
40000111:	e8 ea 01 00 00       	call   40000300 <printf>
	vcprintf(fmt, ap);
40000116:	58                   	pop    %eax
...
4000011f:	e8 7c 01 00 00       	call   400002a0 <vcprintf>
	va_end(ap);
}
...
4000013c:	68 50 12 00 40       	push   $0x40001250
40000141:	e8 ba 01 00 00       	call   40000300 <printf>
	vcprintf(fmt, ap);
40000146:	58                   	pop    %eax
...
4000014f:	e8 4c 01 00 00       	call   400002a0 <vcprintf>
40000154:	83 c4 10             	add    $0x10,%esp
40000157:	90                   	nop
40000158:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
4000015f:	00 
	va_end(ap);

	while (1)
		yield();
40000160:	e8 8b 08 00 00       	call   400009f0 <yield>
	while (1)
40000165:	eb f9                	jmp    40000160 <panic+0x30>
40000167:	66 90                	xchg   %ax,%ax
40000169:	66 90                	xchg   %ax,%ax
4000016b:	66 90                	xchg   %ax,%ax
4000016d:	66 90                	xchg   %ax,%ax
4000016f:	66 90                	xchg   %ax,%ax
40000171:	66 90                	xchg   %ax,%ax
40000173:	66 90                	xchg   %ax,%ax
...
40000479:	ff 24 85 e8 12 00 40 	jmp    *0x400012e8(,%eax,4)
			putch('%', putdat);
